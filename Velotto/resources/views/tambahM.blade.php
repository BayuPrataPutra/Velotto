        ...
        <div id="formPemesanan">
            <div class="container-fluid p-3">
                ...
                <div class="card rounded-4" style="background-color: #dddddd;">
                    <form action="/velotto/storeM" class="p-2" method="post">
                        {{ csrf_field() }}
                        <div class="row m-0">
                            <div class="form-group p-2 col-6">
                                <input type="text" class="form-control" name="merk" placeholder="Merek Mobil" required>
                            </div>
                            <div class="form-group p-2 col-6">
                                <input type="text" class="form-control" name="tipe" placeholder="Tipe Mobil" required>
                            </div>
                        </div>
                        <div class="row m-0">
                            <div class="form-group p-2 col-12">
                                <input type="tel" class="form-control" name="harga" placeholder="Harga Perhari" required>
                            </div>
                        </div>
                        <div class="row">
