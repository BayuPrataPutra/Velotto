...
<head>
    ...
    <title>Velotto Admin - History</title>
...
<body>
    ...
    <div class="p-4" id="main-content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <p class="h3 ps-2">Order History</p>
                <div class="card">
                    <div class="card-body">
                        <div class="scrollable-tabley">
                            <table class="table text-center">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $r->ket_sts }}</td>
                                    <td>
                                      <a class="btn btn-danger" href="/velotto/hapus/{{ $r->id_transaksi }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-trash" viewBox="0 0 16 16">
                                            ...
                                            <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z"/>
										                  ...
										                  <a class="btn btn-success" href="/velotto/edit/{{ $r->id_transaksi }}">Edit</a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
