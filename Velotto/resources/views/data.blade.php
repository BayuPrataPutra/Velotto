...
<head>
    ...
    <title>Velotto Admin - Data</title>
...
<body>
    ...
    <div class="p-4" id="main-content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <p class="h3 ps-2">Data Mobil</p>
                <a href="/velotto/tambahM" class="btn btn-primary m-1">+ Tambah Mobil</a>
                <div class="card card2">
                    <div class="card-body">
                        <div class="scrollable-table2 scrollable-tabley">
                            <table class="table text-center">
                                ...
                                <tr>
                                  <td>{{ $m->merk }}</td>
                                  <td>{{ $m->tipe }}</td>
                                  <td><p class="d-inline">Rp. </p>{{ $m->harga }}</td>
                                  <td>
                                    <a class="btn btn-danger" href="/velotto/hapusM/{{ $m->id_mobil }}">
                                    ...
                                    <a class="btn btn-success" href="/velotto/editM/{{ $m->id_mobil }}">Edit</a>
                                  </td>
                                </tr>
                                @endforeach
                                </tbody>
        ...
        <div class="row">
            <div class="col-12">
                <p class="h3 ps-2">Data Pesanan</p>
                <div class="card">
                    <div class="card-body">
                      <div class="scrollable-tabley">
                      <table class="table text-center">
                            <thead>
                              <tr>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td>
                                  <a href="/velotto/detail/{{$r->id_transaksi}}" class="btn btn-secondary-subtle border border-1" >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="black" class="bi bi-search my-1" viewBox="0 0 16 16">
                                      <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
                                    </svg>
                                  </a>
                                </td>
                                <td class="align-middle">{{ $r->nama }}</td>
                                <td class="align-middle">{{ $r->jenis }}</td>
                                <td class="align-middle">{{ $r->tgl_ambil }}</td>
                                <td class="align-middle">{{ $r->ket_sts }}</td>
                                <td class="align-middle">{{ $r->jumlah}}</td>
                              </tr>
                              @endforeach
                            </tbody>
                        </table>
